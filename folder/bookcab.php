<?php
 ...
 <div class="categories">
       <!-- <div class="small-container"> -->
         <h2 class="title">Book Your Cab</h2>
         <!-- <div class="row"> -->
           <!-- <div class="col-3"> -->
           <!-- <div class="rating"> -->
              </center>
              <table border=2 class="table" cellspacing=10 width=15%>
                <tr>
                  <!-- <th>NAME</th>
                  <th>VEHICAL_TYPE</th>
                  <th>AVAILABILITY</th> -->
  ...
  <?php
    echo "<tr>
               ...
               <td><center> <a href = ' traveller_form.php '><input type='submit' value='Book' class='book' name='book' ></a></center>
  ...
  ?>
 <!-- <a href="manageCabs.php" class ="btn2">ADD CABS</a> -->
           <!--   <div class="rating">
              </div>
            
             <i class="fa-solid fa-taxi"></i>
             </div>
             <a href="traveller_form.php"><h2>Camry-440</h2></a>
             <p>6 seater<br>
             Toyota Camry</p>
           </div>
          <div class="col-3">
