<?php
 ...
 <div class="categories">
       ...
       <center>
              <h3>Enter Your Email To View Your Booking</h3><br>
              <form action="user_cab_status.php" method="POST">
 ...
 $query = "SELECT * FROM `booking table` WHERE EMAIL= '$email'";
...
?>
  ...
  <tr>
                                ...
                                ?>
                                    ...
                                    <td>
                                        <?php
                                        if ($row['DriverStatus'] == 'Assigned') {
                                            if ($row['PaymentStatus'] == NULL) {
                                                echo "<a href='payment_form.php?Cost=" . $row['TravelCost'] . "' class='pay'>Pay</a>";
                                            } else {
                                                echo "Paid";
                                            }
                                        }
