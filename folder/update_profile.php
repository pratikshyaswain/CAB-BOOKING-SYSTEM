<?php
 ...
 <div class="categories">
       ...
       <center>
              <h3>Enter Your Email To View Your Profile</h3><br>
              <form action="" method="POST">
                <input type="email" name="email" class="a" placeholder="Enter Your Email!"/>
                <input type="submit" name="submit" class="b" value="Enter"/>
</form>
  <br>
  <?php
...
$total=mysqli_num_rows($data);
 if($total!=0){
?>
  <h2 class="title"> My Profile

           <!-- <div class="rating"> -->
              </center>
              <table border=2 class="table" cellspacing=10 >
                <tr>
                                <th> Name </th>
                                <th> Email </th>
                                <th>Gender </th>
  ...
  <?php
    while($result=mysqli_fetch_assoc($data)){
        ...
        <td>".$result["PHONE"]."</td>
        <td class='td'> <a href = 'update_code.php?EMAIL=$result[EMAIL]'><input type='submit' value='UPDATE' class='update' name='update' ></a>
       
        </tr>
   ";
 }        
 // echo $result['NAME']." ".$result['EMAIL']." ".$result['GENDER']." ".$result['PASSWORD']."<br>";
}else{
